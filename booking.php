<?php
$con1=mysqli_connect("localhost","id16023371_bookank","Carbook@123456");
$db=mysqli_select_db($con1,"id16023371_book");
$a=false;
...
$query="INSERT INTO `booking`(`Fname`, `Lname`, `Email`, `Phone`, `Cars`,`Duration`, `Note`,`Time`) VALUES ('$fname', '$lname',
 '$email', '$phone','$cars','$dur','$note', current_timestamp());";
